...
namespace Library.Controllers
{
    ...
    public class BooksController : ApiController
    {
		...
		*/
		...
		// GET api/Books/id
		public List<MostCommonWords> Getbooks(int id)
		{
            try
            {
				BooksRepository br = new BooksRepository();
				List<MostCommonWords> top10CommonWords = br.GetTopCommonWords(id).TopCommonWords;
		...
		public List<MostCommonWords> Getbooks(int id, string query)
        {
            try
            {
				BooksRepository br = new BooksRepository();
